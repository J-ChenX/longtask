...
| 2 | 第三阶段为每个模块创建默认单文件文档，复杂模块展开为 README.md + architecture.md（按需） | [doc-architecture.md:58-120](../../../doc-architecture.md#L58) |
...
| L1 血肉 | modules/{name}.md 或 modules/{name}/README.md | 模块业务视角（职责、流程、规则） | 10 分钟 |
...
| 规则 | 触发条件 | 代码 |
|------|---------|------|
| 主文档必须 | 每个模块至少创建单文件主文档或展开目录 README.md | [doc-architecture.md](../../../doc-architecture.md) |
